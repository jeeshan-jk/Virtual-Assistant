...
from cv2 import bgsegm as bgsegm
from cv2 import bioinspired as bioinspired
from cv2 import ccm as ccm
from cv2 import colored_kinfu as colored_kinfu
from cv2 import cuda as cuda
from cv2 import datasets as datasets
from cv2 import detail as detail
from cv2 import dnn as dnn
from cv2 import dnn_superres as dnn_superres
from cv2 import dpm as dpm
from cv2 import dynafu as dynafu
from cv2 import face as face
from cv2 import fisheye as fisheye
from cv2 import flann as flann
from cv2 import ft as ft
...
from cv2 import large_kinfu as large_kinfu
from cv2 import legacy as legacy
from cv2 import line_descriptor as line_descriptor
from cv2 import linemod as linemod
from cv2 import mcc as mcc
from cv2 import ml as ml
from cv2 import motempl as motempl
from cv2 import multicalib as multicalib
from cv2 import ocl as ocl
from cv2 import ogl as ogl
from cv2 import omnidir as omnidir
from cv2 import optflow as optflow
from cv2 import parallel as parallel
from cv2 import phase_unwrapping as phase_unwrapping
from cv2 import plot as plot
from cv2 import ppf_match_3d as ppf_match_3d
from cv2 import quality as quality
from cv2 import rapid as rapid
from cv2 import reg as reg
...
from cv2 import videostab as videostab
from cv2 import wechat_qrcode as wechat_qrcode
from cv2 import xfeatures2d as xfeatures2d
from cv2 import ximgproc as ximgproc
from cv2 import xphoto as xphoto
...
TrackerKCF_MODE = int
"""One of [TrackerKCF_GRAY, TRACKER_KCF_GRAY, TrackerKCF_CN, TRACKER_KCF_CN, TrackerKCF_CUSTOM, TRACKER_KCF_CUSTOM]"""
...
class HistogramCostExtractor(Algorithm):
    # Functions
    @_typing.overload
    def buildCostMatrix(self, descriptors1: cv2.typing.MatLike, descriptors2: cv2.typing.MatLike, costMatrix: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
    @_typing.overload
    def buildCostMatrix(self, descriptors1: UMat, descriptors2: UMat, costMatrix: UMat | None = ...) -> UMat: ...

    def setNDummies(self, nDummies: int) -> None: ...

    def getNDummies(self) -> int: ...

    def setDefaultCost(self, defaultCost: float) -> None: ...

    def getDefaultCost(self) -> float: ...


class NormHistogramCostExtractor(HistogramCostExtractor):
    # Functions
    def setNormFlag(self, flag: int) -> None: ...

    def getNormFlag(self) -> int: ...
...
class ShapeDistanceExtractor(Algorithm):
    # Functions
    @_typing.overload
    def computeDistance(self, contour1: cv2.typing.MatLike, contour2: cv2.typing.MatLike) -> float: ...
    @_typing.overload
    def computeDistance(self, contour1: UMat, contour2: UMat) -> float: ...


class ShapeContextDistanceExtractor(ShapeDistanceExtractor):
    # Functions
    def setAngularBins(self, nAngularBins: int) -> None: ...

    def getAngularBins(self) -> int: ...

    def setRadialBins(self, nRadialBins: int) -> None: ...

    def getRadialBins(self) -> int: ...

    def setInnerRadius(self, innerRadius: float) -> None: ...

    def getInnerRadius(self) -> float: ...

    def setOuterRadius(self, outerRadius: float) -> None: ...

    def getOuterRadius(self) -> float: ...

    def setRotationInvariant(self, rotationInvariant: bool) -> None: ...

    def getRotationInvariant(self) -> bool: ...

    def setShapeContextWeight(self, shapeContextWeight: float) -> None: ...

    def getShapeContextWeight(self) -> float: ...

    def setImageAppearanceWeight(self, imageAppearanceWeight: float) -> None: ...

    def getImageAppearanceWeight(self) -> float: ...

    def setBendingEnergyWeight(self, bendingEnergyWeight: float) -> None: ...

    def getBendingEnergyWeight(self) -> float: ...

    @_typing.overload
    def setImages(self, image1: cv2.typing.MatLike, image2: cv2.typing.MatLike) -> None: ...
    @_typing.overload
    def setImages(self, image1: UMat, image2: UMat) -> None: ...

    @_typing.overload
    def getImages(self, image1: cv2.typing.MatLike | None = ..., image2: cv2.typing.MatLike | None = ...) -> tuple[cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def getImages(self, image1: UMat | None = ..., image2: UMat | None = ...) -> tuple[UMat, UMat]: ...

    def setIterations(self, iterations: int) -> None: ...

    def getIterations(self) -> int: ...

    def setCostExtractor(self, comparer: HistogramCostExtractor) -> None: ...

    def getCostExtractor(self) -> HistogramCostExtractor: ...

    def setStdDev(self, sigma: float) -> None: ...

    def getStdDev(self) -> float: ...

    def setTransformAlgorithm(self, transformer: ShapeTransformer) -> None: ...

    def getTransformAlgorithm(self) -> ShapeTransformer: ...


class HausdorffDistanceExtractor(ShapeDistanceExtractor):
    # Functions
    def setDistanceFlag(self, distanceFlag: int) -> None: ...

    def getDistanceFlag(self) -> int: ...

    def setRankProportion(self, rankProportion: float) -> None: ...

    def getRankProportion(self) -> float: ...


class ShapeTransformer(Algorithm):
    # Functions
    @_typing.overload
    def estimateTransformation(self, transformingShape: cv2.typing.MatLike, targetShape: cv2.typing.MatLike, matches: _typing.Sequence[DMatch]) -> None: ...
    @_typing.overload
    def estimateTransformation(self, transformingShape: UMat, targetShape: UMat, matches: _typing.Sequence[DMatch]) -> None: ...

    @_typing.overload
    def applyTransformation(self, input: cv2.typing.MatLike, output: cv2.typing.MatLike | None = ...) -> tuple[float, cv2.typing.MatLike]: ...
    @_typing.overload
    def applyTransformation(self, input: UMat, output: UMat | None = ...) -> tuple[float, UMat]: ...

    @_typing.overload
    def warpImage(self, transformingImage: cv2.typing.MatLike, output: cv2.typing.MatLike | None = ..., flags: int = ..., borderMode: int = ..., borderValue: cv2.typing.Scalar = ...) -> cv2.typing.MatLike: ...
    @_typing.overload
    def warpImage(self, transformingImage: UMat, output: UMat | None = ..., flags: int = ..., borderMode: int = ..., borderValue: cv2.typing.Scalar = ...) -> UMat: ...


class ThinPlateSplineShapeTransformer(ShapeTransformer):
    # Functions
    def setRegularizationParameter(self, beta: float) -> None: ...

    def getRegularizationParameter(self) -> float: ...


class AffineTransformer(ShapeTransformer):
    # Functions
    def setFullAffine(self, fullAffine: bool) -> None: ...

    def getFullAffine(self) -> bool: ...
...
class TrackerCSRT(Tracker):
    ...
    class Params:
        ...
        window_function: str
        kaiser_alpha: float
        cheb_attenuation: float
        template_size: float
        gsl_sigma: float
        hog_orientations: float
        hog_clip: float
        padding: float
        filter_lr: float
        weights_lr: float
        num_hog_channels_used: int
        admm_iterations: int
        histogram_bins: int
        histogram_lr: float
        background_ratio: int
        number_of_scales: int
        scale_sigma_factor: float
        scale_model_max_area: float
        scale_lr: float
        scale_step: float
        psr_threshold: float
    ...
    # Functions
    @classmethod
    def create(cls, parameters: TrackerCSRT.Params = ...) -> TrackerCSRT: ...

    @_typing.overload
    def setInitialMask(self, mask: cv2.typing.MatLike) -> None: ...
    @_typing.overload
    def setInitialMask(self, mask: UMat) -> None: ...
...
class TrackerKCF(Tracker):
    ...
    # Functions
    @classmethod
    def create(cls, parameters: TrackerKCF.Params = ...) -> TrackerKCF: ...
...
def createAffineTransformer(fullAffine: bool) -> AffineTransformer: ...
...
def createChiHistogramCostExtractor(nDummies: int = ..., defaultCost: float = ...) -> HistogramCostExtractor: ...

def createEMDHistogramCostExtractor(flag: int = ..., nDummies: int = ..., defaultCost: float = ...) -> HistogramCostExtractor: ...

def createEMDL1HistogramCostExtractor(nDummies: int = ..., defaultCost: float = ...) -> HistogramCostExtractor: ...
...
def createHausdorffDistanceExtractor(distanceFlag: int = ..., rankProp: float = ...) -> HausdorffDistanceExtractor: ...
...
def createNormHistogramCostExtractor(flag: int = ..., nDummies: int = ..., defaultCost: float = ...) -> HistogramCostExtractor: ...

def createShapeContextDistanceExtractor(nAngularBins: int = ..., nRadialBins: int = ..., innerRadius: float = ..., outerRadius: float = ..., iterations: int = ..., comparer: HistogramCostExtractor = ..., transformer: ShapeTransformer = ...) -> ShapeContextDistanceExtractor: ...

def createThinPlateSplineShapeTransformer(regularizationParameter: float = ...) -> ThinPlateSplineShapeTransformer: ...
